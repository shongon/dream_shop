...
import com.shongon.dreamshop.exceptions.ProductNotFoundException;
import com.shongon.dreamshop.model.Category;
import com.shongon.dreamshop.model.Product;
import com.shongon.dreamshop.repository.CategoryRepository;
import com.shongon.dreamshop.repository.ProductRepository;
...
public class ProductService implements IProductService {
    ...
    public Product addProduct(AddProductRequest request) {
        //Check the category is found in DB
            //If yes, set it as a new product of category (existed)
            //Else, create new category and save that category
                // then save it (product) as a new product of new category created
